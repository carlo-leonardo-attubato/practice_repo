"""
Unit Tests for Speed Drill 4: Inventory System
These tests will pass when you implement the Inventory class correctly.
"""
...
from speed_drills.inventory_system import Inventory
...
def run_tests():
    ...
    print("🧪 Speed Drill 4: Inventory System")
    print("=" * 50)
    ...
    print("python -m pytest tests/test_04_inventory_system.py -v")

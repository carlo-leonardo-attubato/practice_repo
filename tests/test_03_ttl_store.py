"""
Unit Tests for Speed Drill 3: TTL Store
These tests will pass when you implement the TTLStore class correctly.
"""
...
from speed_drills.ttl_store import TTLStore
...
class TestTTLStore:
    ...
    def test_initialization(self):
        ...
        assert hasattr(self.store, 'expiry')
...
def run_tests():
    ...
    print("python -m pytest tests/test_03_ttl_store.py -v")
